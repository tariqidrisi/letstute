...
<head>
    ...
    <title>LetsTute | Modern Educational site template</title>
...
<?php
						...
						$subject = "Admission from LetsTute";
						$headers = "From: Admission from LetsTute <noreply@yourdomain.com>";
						$message = "DETAILS\n";
						...
						$userheaders = "From: info@letstute.com\n";

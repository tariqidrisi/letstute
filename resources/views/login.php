		...
		<aside>
			<figure>
			  ...
			  <form>
				...
				<a href="#0" class="btn_1 rounded full-width add_top_60">Login to LetsTute</a>
				<div class="text-center add_top_10">New to LetsTute? <strong><a href="register">Sign up!</a></strong></div>
			</form>
			<div class="copy">© 2019 LetsTute</div>
		</aside>
	</div>
	<!-- /login -->
